...
export const SecretCreateInputSchema = z
  ...
  .meta({ id: 'CustomerSecretCreateInput' })
...
export const SecretRotateInputSchema = z
  ...
  .meta({ id: 'CustomerSecretRotateInput' })
...
export const SecretSummarySchema = z
  ...
  .meta({
    id: 'CustomerSecretSummary',
    description:
      'Metadata for a Customer-scoped secret. The plaintext is returned exactly once from create + rotate; subsequent fetches return only this summary.',
  })
...
export const SecretRevealedResponseSchema = z
  ...
  .meta({
    id: 'CustomerSecretRevealedResponse',
    description:
