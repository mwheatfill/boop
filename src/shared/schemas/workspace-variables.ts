...
export const VariableMapSchema = z
  ...
  .meta({
    id: 'VariableMap',
    description:
      'Operator-defined variables. Keys match ^[a-z][a-z0-9_]{0,63}$. Up to 64 entries. Workspace-level entries are inherited by Jobs; Job-level entries override by name.',
  })
